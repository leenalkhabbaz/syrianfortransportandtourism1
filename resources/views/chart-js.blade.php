                    ...
                    <div class="card-body pb-2">
                        <div class="d-flex align-items-start mb-4 mb-lg-0">
                            <div class="flex-grow-1">
                                <h5 class="card-title mb-0">{{ $beachData['beachName'] }}</h5>
                            </div>
                        </div>
            ...
            <div class="col-xl-4">
                ...
                <script>
                    $(function () {
                        ...
                        var chartData{{ $loop->iteration }} = {!! json_encode($beachData['chartData']) !!};
                        ...
                        var roomReservations{{ $loop->iteration }} = @json($roomReservations[$beachData['beachName']]);
