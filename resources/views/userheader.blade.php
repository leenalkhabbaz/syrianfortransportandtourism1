        ...
        <header id="page-topbar">
            <div class="navbar-header">
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        <a href="/showaddrole">
                            <button type="button" class="btn header-item noti-icon right-bar-toggle" id="right-bar-toggle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="قبول الاغراض المقترحة">
                                <i class="fas fa-check fa-4x icon-sm"></i>
                            </button>
                        </a>
                    </div>
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="topnav-more">
                                                    ...
                                                    <a href="/to" class="dropdown-item"
                                                        ...
                                                        <a href="/showEmployee" class="dropdown-item"
                                                        data-key="t-vertical">عرض الموظفين </a>
...
@endrole
    ...
    <script src="{{asset('js/pages/ecommerce-product-detail.init.js')}}"></script>
