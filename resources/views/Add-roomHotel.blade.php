...
@section('content')
      ...
      <!-- choices css -->
        ...
        <link href="{{asset('libs/dropzone/min/dropzone.min.css')}}" rel="stylesheet" type="text/css" />
            ...
            <form method="POST" action="/createRoomHotel/{{$hotels->id}}" enctype='multipart/form-data'>
            @method('POST')
            @csrf
            <!-- ============================================================== -->
                                        ...
                                        <div id="addproduct-metadata-collapse" class="collapse" data-bs-parent="#addproduct-accordion">
                                            <div class="p-4 border-top">
                                                    ...
                                                    <div class="mb-0">
                                                        ...
                                                        <textarea class="form-control" name="description"id="description" placeholder="" rows="4"></textarea>
                                                    </div>
