                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card" dir="rtl">
                                    <div class="card-header justify-content-between d-flex align-items-center">
                                        ...
                                        @role('admin')
                                    <a href="/ShowInfoHotel/{{$hotel->id}}" class="card-link" ><h4 class="card-title"style="color: #123A5D; "> {{ $hotel->name }}</h4> </a>
                                    @endrole

                                    @role('employee1')
                                    <a href="/ShowInfoHotelEmp/{{$hotel->id}}" class="card-link" ><h4 class="card-title"style="color: #123A5D; "> {{ $hotel->name }}</h4> </a>
                                    @endrole
