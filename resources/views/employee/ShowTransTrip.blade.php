...
<div class="card-body">
    ...
    @foreach ($lines->tour_street as $tour_street)
<div class="col-lg-4" dir="rtl">
    <div class="card">
        <h6 class="card-header text-purple"> رقم الرحلة : {{$tour_street->id}}  </h6>
     ...
     <div class="row">
                       ...
                       <div class="col-md-8">
                            ...
                            <div class="card-body">
                                ...
                                <a href="#" class="btn btn-pink"> عرض الحجوزات </a>
