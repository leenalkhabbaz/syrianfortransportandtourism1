                            ...
                            <div class="text-center mb-4">
                                ...
                                <div>
                                    <div class="mb-3">
                                        ...
                                        <input id="projectname" type="text" class="form-control"name="title" >
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="number" value="" id="example-number-input"name="person_count">
                                   </div>
                                        </div>
                                        <div class="col-lg-6">
                                   <div class="mb-3">
                                    <label for="example-number-input" class="col-md-2 col-form-label" >عدد ايام الرحلة</label>
                                    <input class="form-control" type="number" value="" id="example-number-input"name="days_count">
                               </div>
                            </div>
                            <!-- row -->
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id=""name="starting_place">
                                    </div>
                                </div>
                                <!-- col
                                 -->
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="datepicker-basic"name="date">
                                    </div>
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="time" class="form-control" id="datepicker-timepicker"name="starting_time">
                                    </div>
                                        </div>
                                    </div>
                        ...
                        <div class="wizard-tab"dir="rtl">
                                ...
                                <div>
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control"name="tour_pro" id="projectdesc" rows="5" placeholder=""></textarea>
                                    </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control"name="tour_place" id="projectdesc" rows="5" placeholder=""></textarea>
