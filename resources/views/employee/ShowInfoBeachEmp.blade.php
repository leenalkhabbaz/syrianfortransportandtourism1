    ...
    <div class="row">
        ...
        <div class="card" dir="rtl">
            <div class="card-header justify-content-between d-flex align-items-center">
                <!-- <div class="row"> -->
                <div class="col-sm-8">
                    <h4 class="card-title">{{$beachs->name}}</h4>
                </div>
                <div class=".col-6 .col-md-4">
                    <a href="/ShowBeachBook/{{$beachs->id}}">  <button type="button"  class="btn btn-soft-purple">عرض الحجوزات</button></a>
