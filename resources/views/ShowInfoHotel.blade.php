        ...
        <div class="row">
            ...
            <div class="card" dir="rtl">
                <div class="card-header justify-content-between d-flex align-items-center">
                    <!-- <div class="row"> -->
                    <div class="col-sm-8">
                        <h4 class="card-title"style="color: #123A5D; ">{{ $hotels->name }}</h4>
                    </div>
                    <div class=".col-6 .col-md-4">
                        <a href="/ShowAddRoomHotel/{{ $hotels->id }}"> <button type="button"
                                class="btn btn-soft-purple">اضافة غرفة</button></a>
                        <a href="/showedithotel/{{ $hotels->id }}"> <button type="button"
                                class="btn btn-soft-purple">تعديل معلومات الفندق</button></a>
                                                    ...
                                                    <div class="col-xl-4">
                                                        <div class="product-detail">
                                                                ...
                                                                <div class="swiper-wrapper ">
                                                                    @foreach ($room->images as $image1)
                                                                        <div class="swiper-slide">
                                                                            <img src="{{ asset('storage/pic/' . $image1->url) }}"
                                                            ...
                                                            <div class="modal fade"
                                                                id="exampleModalScrollable{{ $image1->id }}"
                                                                                                ...
                                                                                                <div class="row">
                                                                                                    <div class="col-lg-12">
                                                                                                        <div>
                                                                                                            ...
                                                                                                            <a href="{{ asset('storage/pic/' . $image1->url) }}"
                                                            ...
                                                            <div class="row text-center mt-3">
                                                                        ...
                                                                        <div class="modal fade" id="staticBackdrop"
                                                                            ...
                                                                            <div class="modal-dialog modal-dialog-centered"
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <!-- end modalheader -->
                                                                                    <div class="modal-body">
                                                                                        <p>هل تريد ازالة الغرفة من الخدمة
                                                                                            وعدم امكانية حجزها من قبل
                                                                                            المستخدم</p>
                                                                                    </div>
                                                                                    <!-- end modalbody -->
                                                                                    <div class="modal-footer">
                                                                                        <a
                                                                                            href="/notavailable/{{ $room->id }}">
                                                                                            <button type="button"
                                                                                                class="btn btn-soft-purple">
                                                                                                NO</button></a>
                                                                                        <a
                                                                                            href="/available/{{ $room->id }}">
                                                                                            <button type="button"
                                                                                                class="btn btn-soft-pink">yes
                                                                                            </button></a>
                                                                                    </div>
                                                                                    <!-- end modalfooter -->
                                                                                </div>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="d-grid">
                                                                        <a href="/calander/{{ $room->id }}"> <button
                                                                                type="button"
                                                        ...
                                                        <div class="mt-4 mt-xl-3 ps-xl-4">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-8">
                                                                    ...
                                                                    <h5 class="font-size-20 mt-4 pt-2"> السعر
                                                                        :{{ $room->one_day_price }}</h5>

                                                                    <p class="mt-4 text-muted"> الوصف
                                                                        :{{ $room->description }} </p>
                                                                ...
                                                                <div class="col-sm">
                                                                    <a href="/deleteroom/{{ $room->id }}"
                                                                        class="text-muted px-5" type="submit">
                                                                        <i class="mdi mdi-trash-can-outline fa-2x"></i>
                                                                    </a>
                                                                    <br>
                                                                    <br>
                                                                    <a href="/showeditroomm/{{ $room->id }}"
