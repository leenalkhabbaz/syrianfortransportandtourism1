...
@section('content')
      ...
      <!-- choices css -->
        ...
        <link href="{{asset('libs/dropzone/min/dropzone.min.css')}}" rel="stylesheet" type="text/css" />
            ...
            <form method="POST"action="/editHotel/{{$hotel->id}}" enctype='multipart/form-data'>
            @method('POST')
            @csrf
            <!-- ============================================================== -->
                                        ...
                                        <div id="addproduct-billinginfo-collapse" class="collapse show" data-bs-parent="#addproduct-accordion">
                                            <div class="p-4 border-top"dir="rtl">
                                                ...
                                                <div class="mb-3" >
                                                    ...
                                                    <input id="beachname"  name="name"  value ="{{$hotel_name}}"placeholder="" type="text" class="form-control">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input id="adress" name="address" value="{{$hotel_address}}" placeholder="" type="text" class="form-control">
                                                        </div>
                                                        <div class="mb-3">
                                                        <label for="example-number-input" class="col-md-2 col-form-label" >عدد الغرف</label>

                                                            <input class="form-control" type="number" value="{{$hotel_number_of_room}}" id="example-number-input"name="number_of_room">
                                                        </div>
                                                        <div class="mb-3">
                                                        <label for="example-tel-input" class="col-md-2 col-form-label">رقم الهاتف</label>
                                                    <input class="form-control" type="tel" value="{{$hotel_phone_number}}" id="example-tel-input"name="phone_number">
                                                        </div>
                                        ...
                                        <div id="addproduct-metadata-collapse" class="collapse" data-bs-parent="#addproduct-accordion">
                                            <div class="p-4 border-top">
                                                ...
                                                <div class="mb-0">
                                                    ...
                                                    <textarea class="form-control" name="description" type="text"id="metadescription" placeholder="" rows="4"> {{ old('description', $hotel_description) }}</textarea>
                                                </div>
